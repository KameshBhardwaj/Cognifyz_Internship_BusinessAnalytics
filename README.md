...
**Steps:**
1. Review the Purpose column for reasons.
2. Drop missing values and count the frequency of unique reasons.
3. Summarize the most common reasons.
...
**Steps:**
1. Analyze the "What are your savings objectives?" column.
2. Count the unique savings objectives and their frequency.
3. Summarize the main objectives.
...
**Steps:**
1. Review the column where participants indicated their sources of investment information.
2. Analyze the data to summarize the most common sources.
...
**Steps:**
1. Analyze the "Investment Duration" column.
2. Map duration ranges to numerical values and calculate the average duration.
